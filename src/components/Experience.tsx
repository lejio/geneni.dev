...
export default function Experience() {
  ...
  // #052f73
  return (
    <div className="z-10 p-5 max-w-[1920px] w-full h-full flex flex-col justify-center items-center gap-20 md:gap-28 align-middle">
      <div className="flex flex-col justify-center items-center align-middle p-10 gap-2">
        <img
          src="/msu_seal.svg"
          alt="MSU Seal"
      ...
      {/* <div className="flex w-full h-full justify-center items-center flex-col gap-20 md:gap-80"> */}
      <div className="flex flex-col w-1/2 max-w-[720px] h-full justify-start items-center align-middle gap-5">
        ...
        <ul className="text-xs md:text-base text-[#18453B] list-disc pl-5">
          <li className="stagger">
            <p>
              ...
              by 4x. Utilized onboard memory to cache data and reduce the
              frequency of network requests
            </p>
          </li>
          <li className="stagger">
            <p>
              Utilized low-power mode during down time to extend battery life
            </p>
          </li>
          <li className="stagger">
      ...
      <div className="flex flex-col rounded w-1/2 max-w-[720px] h-full justify-center items-center align-middle gap-2">
          ...
          <div className="flex flex-row justify-start gap-3 w-full">
            <div className="flex flex-col gap-4">
              ...
              <ul className="text-xs md:text-base text-[#18453B] text-wrap list-disc pl-5">
                ...
                <li className="stagger-2">
                  <p>Active userbase of 300+ farmers across Michigan</p>
                </li>
                <li className="stagger-2">
                  <p>
                    Utilized Firebase functions to reduce the number of fetch
          ...
          <div className="flex flex-row justify-start gap-3 w-full">
            <div className="flex flex-col gap-4">
              ...
              <ul className="text-xs md:text-base text-[#18453B] text-wrap list-disc pl-5">
                ...
                <li className="stagger-3">
                  <p>
                    Scalable, allowing for future expansion to other
                    universities and states
                  </p>
                </li>
                <li className="stagger-3">
                  <p>Optimized for one handed use while on the field</p>
                </li>
              </ul>
            </div>
            <img
